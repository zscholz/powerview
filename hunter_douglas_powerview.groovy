...
void firmwareVerCallback(physicalgraph.device.HubResponse hubResponse) {
...
def triggerSceneCallback(physicalgraph.device.HubResponse hubResponse) {
...
void repeatersCallback(physicalgraph.device.HubResponse hubResponse) {
...
void setRepeaterPrefsCallback(physicalgraph.device.HubResponse hubResponse) {
...
void repeaterPollCallback(physicalgraph.device.HubResponse hubResponse) {
